...
[
  ...
  if test "x$OPENJDK_TARGET_OS" = xlinux; then
    ...
    CFLAGS_OS_DEF_JVM="-DLINUX -D_ALLBSD_SOURCE -D_FILE_OFFSET_BITS=64 -DANDROID -D_GNU_SOURCE"
    CFLAGS_OS_DEF_JDK="-DLINUX -D__USE_BSD -D_FILE_OFFSET_BITS=64 -DANDROID -D_GNU_SOURCE -D_REENTRANT -D_ALLBSD_SOURCE"
